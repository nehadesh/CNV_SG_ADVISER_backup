 ...
 * @author gerikson
 */
public class CnvIDIOMmultipleChildren extends javax.swing.JFrame
{
	...
	public static CnvIDIOMmultipleChildren fr;
	 ...
	 */
	public CnvIDIOMmultipleChildren()
	{
		// initComponents();
		MyinitComponents();
	}
	...
	public void MyinitComponents()
	{
		...
		jComboBox5.addActionListener(new java.awt.event.ActionListener()
		{
			...
			public void actionPerformed(java.awt.event.ActionEvent evt)
			{
				...
				System.out
						.println("From IDIOMmultipleChilder affected Geno is: "
								+ affectedGeno);
	...
	public static void main(String args[])
	{
		...
		} catch (ClassNotFoundException ex)
		{
			java.util.logging.Logger.getLogger(
					CnvIDIOMmultipleChildren.class.getName()).log(
		...
		java.awt.EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				fr = new CnvIDIOMmultipleChildren();
				fr.setVisible(true);
